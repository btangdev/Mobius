var option = {
    data: ['data', '사원', '주임', '대리', '과장', '차장'],
    yAxis: [['lineData-0', 2800, 2600, 2800, 3800, 6300], ['lineData-1', 3200, 4000, 3500, 4800, 5480], ['lineData-2', 3600, 3600, 4000, 5800, 6000], ['lineData-3', 2400, 3400, 5000, 6800, 6120]],
    svgWidth: 960,
    svgHeight: 360,
    ...
    label: false,
    pointFillColor: '#fff',
    pointStrokeColor: ['#359aff','#fa6048','#8971bf','#f3bb34', '#61c3af'],
    pointRad: 4,
    pointExpand: false,
    pointExpandRate: 1.75,
    colorPattern: ['#359aff','#fa6048','#8971bf','#f3bb34', '#61c3af'],
    x_grid: true,
    y_grid: true,
    legend: false,
    regions_start: 1,
