var option = {
    data: ['data', '20세이하', '21~25세', '26~30세', '31~35세', '36~40세', '41~45세', '46~50세', '51세이상'],
    yAxis: [['lineData-0', 0, 50, 0, 50, 0, 0, 0], ['lineData-1', 50, 60, 50, 80, 50, 40, 60], ['lineData-2', 25, 30, 70, 65, 70, 20, 10]],
    svgWidth: 960,
    svgHeight: 360,
    ...
    label: true,
    pointFillColor: '#fff',
    pointStrokeColor: ['#ff8759', '#61c3af', '#359aff'],
    pointRad: 4,
    pointExpand: false,
    pointExpandRate: 1.75,
    colorPattern: ['#ff8759', '#61c3af', '#359aff'],
    x_grid: false,
    y_grid: true,
    legend: false,
    regions_start: 0,
